...
<%
    Liste documentsListe = new Liste();
    documentsListe.obtenirDocumentsParTitre(request.getParameter("titre"));
    ArrayList<Document> documents = documentsListe.getDocumentsParTitre();
%>
